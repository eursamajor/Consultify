  ...
  <meta name="keywords" content="bootstrap, bootstrap4" />
	...
	<body>
		...
		<nav class="custom-navbar navbar navbar navbar-expand-md navbar-dark bg-dark" arial-label="Furni navigation bar">
			...
			<div class="container">
				<a class="navbar-brand" href="index.html">Consultify<span>.</span></a>
                ...
                <form class="col-md-12" method="post">
                  <div class="site-blocks-table">
                    <table class="table">
                      <thead>
                        <tr>
                          <th class="product-thumbnail">Profil</th>
                          <th class="product-name">Konselor</th>
                          <th class="product-price">Harga</th>
                          <th class="product-quantity">Durasi</th>
                      ...
                      <tbody>
                        <tr>
                          ...
                          <td class="product-name">
                            <h2 class="h5 text-black">Muhammad Rexcel</h2>
                          </td>
                          <td>$49.00</td>
                          <td>
