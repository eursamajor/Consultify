              ...
              <div class="card-body">
                ...
                <form action="/login" method="post">
                  ...
                  <div class="mb-3">
                    ...
                    <input type="username" name="username" class="form-control @error('username') is-invalid @enderror" id="username" placeholder="eursamajor" autofocus value="{{ old('username') }}">
                    @error('username')
